...
언어·비언어 분석 모델은 AI Hub의 **공적 말하기 실습 및 평가 데이터**를 기반으로 학습되었습니다.

| 항목 | 내용 |
|------|------|
| 출처 | [AI Hub — 공적 말하기 실습 및 평가 데이터](https://aihub.or.kr/aihubdata/data/view.do?currMenu=115&topMenu=100&aihubDataSe=data&dataSetSn=71592) |
| 구성 | 발표·면접 영상 + 언어(전사·간투어·속도·발음) + 비언어(포즈 키포인트) 레이블 |
| 용도 | 언어 표현 베이스라인 회귀 모델 및 비언어 행동 분류기 학습 |
| 라이선스 | AI Hub 데이터 이용 정책에 따름 |

> 데이터셋 원본 파일은 용량 문제로 저장소에 포함되지 않습니다.
